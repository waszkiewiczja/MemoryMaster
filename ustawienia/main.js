...
const zmianaNaBialeTlo = () => {
  ...
  imglogo.src = "https://waszkiewiczja.github.io/MemoryMaster/ustawienia/mozg.png";
  ...
  const opisMobile = document.querySelector(".opisMobile");

  mainh1.classList.add("mainh1White");
  opisMobile.classList.add("opisMobileWhite");
};
